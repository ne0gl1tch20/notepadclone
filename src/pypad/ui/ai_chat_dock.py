...
class _Bubble(QFrame):
    def __init__(self, text: str, role: str, parent: QWidget | None = None, copy_icon_data_uri: str = "") -> None:
    ...
    def _render_markdown(self) -> None:
        ...
        processed = re.sub(r"```([^\n`]*)\n(.*?)```", _replace_fenced, self._raw_text, flags=re.DOTALL)
        doc = QTextDocument()
        doc.setMarkdown(processed)
        self._view.setHtml(doc.toHtml())
